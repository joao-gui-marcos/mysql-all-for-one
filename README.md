...
## 👨‍💻 O que foi desenvolvido:
  ...
  - Projeto feito para praticar conceitos de SQL. O banco de dados usado neste projeto foi o `Northwind`. Temos, nesse projeto, uma série de desafios com diferentes níveis de complexidade que devem ser resolvidos cada um em seu arquivo próprio.
